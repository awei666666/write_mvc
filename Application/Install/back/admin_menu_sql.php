<?php	return array ( 'drop' => 'DROP TABLE IF EXISTS `{@prefix}admin_menu`;', 'create' => 'CREATE TABLE `{@prefix}admin_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=299 DEFAULT CHARSET=utf8 COMMENT=\'后台菜单表\';', );?>